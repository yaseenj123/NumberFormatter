...
public class NumberFormatter implements NumberRangeSummarizer {

    static Scanner sc = new Scanner(System.in);

    public static void main(String[] args)
    {
        NumberRangeSummarizer numberRangeSummarizer = new NumberFormatter();

        System.out.print("Enter your collection of numbers: ");
        String input = sc.nextLine();

        String formatted = numberRangeSummarizer.summarizeCollection(numberRangeSummarizer.collect(input));

        System.out.println("New formatted collection of numbers: " + formatted);
    }
